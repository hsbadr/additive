...
This outlines how to propose a change to `additive`. For more detailed
...
Please note that the `additive` project is released with a [Contributor
Code of Conduct](https://hsbadr.github.io/additive/CODE_OF_CONDUCT.md).
